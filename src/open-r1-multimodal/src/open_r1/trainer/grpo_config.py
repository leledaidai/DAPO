...
class GRPOConfig(TrainingArguments):
    ...
    max_completion_length: Optional[int] = field(
        ...
        metadata={
            ...
            "equal to data.max_response_length in verl"
        },
    )
    ...
    filter_max_num_gen_batches: int = field(
        default = 0,
        metadata={
            "help": "τ parameter from the TR-DPO paper, which determines how frequently the current policy is "
            "synchronized with the reference policy. To use this parameter, you must set `sync_ref_model=True`."
    ...
    overlong_buffer_cfg_len: int = field(
        default = 0,
        metadata={
            "help": "equal to overlong_buffer_cfg.len in verl"
            "synchronized with the reference policy. To use this parameter, you must set `sync_ref_model=True`."
        },
    )
    overlong_buffer_cfg_penalty_factor: int = field(
        default = 0,
        metadata={
            "help": "equal to overlong_buffer_cfg.penalty_factor in verl"
            "synchronized with the reference policy. To use this parameter, you must set `sync_ref_model=True`."
        },
    )
